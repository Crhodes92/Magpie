...
import { Camera, AlertTriangle, ExternalLink, CheckCircle, XCircle, Loader2, ArrowLeft } from 'lucide-react'
...
export default function ClassicScoutPage() {
    ...
    <div className="min-h-screen bg-white pb-20 sm:pb-0">
      <div className="max-w-lg mx-auto px-4 py-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-black text-black leading-none">Classic Scout</h1>
            <p className="text-gray-500 text-sm mt-0.5">Photo → identity + comp price in under 30s</p>
          </div>
        </div>
        ...
        {phase === 'loading' && (
          <div className="space-y-4">
            {preview && <img src={preview} alt="" className="w-full rounded-xl object-cover max-h-64 border-2 border-black" />}
        ...
        {phase === 'result' && result && (
          <div className="space-y-4">
            ...
            <div className="bg-white border-2 border-black rounded-xl p-4 space-y-3 shadow-[4px_4px_0_0_#000]">
              ...
              {result.condition_note && <p className="text-gray-500 text-sm italic">{result.condition_note}</p>}
              {lowConfidence && (
